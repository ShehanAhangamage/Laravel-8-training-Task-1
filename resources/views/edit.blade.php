        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            ...
            <form action="/update/{{$booking->id}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="{{ $booking->email }}" class="@error('email') bg-red-100 border-red-400 @else bg-gray-100 border-gray-400 @enderror rounded border leading-normal resize-none w-full mb-2 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white" />
                    @if ($errors->has('email'))
